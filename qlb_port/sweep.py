...
def sweep_circuit(axis, n_pos, m_tilde=0.0, g_tilde=0.0, boundary="periodic",
    ...
    streaming_method : 'mcx' (default; ancilla-free multi-controlled-X ripple) or
        'fourier' (Draper Fourier adder: no ancilla; see
        :func:`streaming.streaming_circuit`).  Ignored for boundary='reflecting'.
